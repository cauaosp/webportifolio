      ...
      <div className="grid grid-cols-3 p-5 pt-10 gap-4 gap-y-0 md:gap-y-20 2xl:gap-y-0 overflow-hidden 2xl:mt-8 2xl:mb-0 ">
        ...
        <div className="text-white overflow-auto col-span-2 h-full row-span-3">
          <div className="flex flex-col gap-6 mb-15">
            ...
            <div className="text-justify mr-10 font-extralight text-neutral-300">
          ...
          <div className="flex flex-col gap-5 pb-10">
            ...
            <div className="flex flex-col gap-3">
              <div className="flex flex-col gap-1 mr-10">
                ...
                <div className="text-md font-extralight text-justify text-neutral-300">
              ...
              <div className="flex flex-col gap-1 mr-10">
                ...
                <div className="text-md font-extralight text-justify text-neutral-300">
                  Trabalhei como voluntário da EJ Include Jr entre 2021 e 2023.
                  Como Desenvolvedor Front-End, desenvolvi páginas com
            ...
            <div className="flex flex-col gap-1 mr-10 tracking-tighter">
              <div className="font-bold text-2xl">
                Universidade de Fortaleza
              </div>
              <div className="text-md font-extralight text-justify text text-neutral-300">
